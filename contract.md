...
- The hero is dark and uses Ace Hits TCG styling cues: black base, bright purple, magenta, yellow and cyan accents, bold condensed display type, the Ace Hits logo, and a Shopify banner image.
...
- The Ace Hits TCG project page has its own black retail visual system with purple, magenta, yellow and cyan accents, product cards, category chips and Shopify-derived imagery.
